...
APP_VERSION = "v5.0-clean-streamlit"
...
def main():
    ...
    st.info(
        "This rewritten version avoids writing files into the app source directory. "
        "Reports are shown in the UI and can be downloaded directly with download buttons."
    )
